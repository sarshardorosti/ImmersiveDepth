...
def filter_taskonomy():
    data = pd.read_csv('/loss_stats/taskonomy_sorted.csv', index_col=0)
...
def filter_blendedMVS():
    data = pd.read_csv('/loss_stats/blendedMVS_sorted.csv', index_col=0)
...
class ImmersiveDepthDataset(data.Dataset):
    '''
    ...
    class Options():
        ...
        replica_data_path: str = '/replica-taskonomized'
        gso_data_path: str = '/replica-google-objects'
        hypersim_data_path: str = '/hypersim-dataset2/evermotion/scenes'
        blendedMVS_data_path: str = '/BlendedMVS/mvs_low_res_taskonomized'
        split: str = 'train'
