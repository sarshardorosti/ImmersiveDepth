...
class ImmersiveDepthDataset(data.Dataset):
    ...
    def __init__(self, options: Options, logger=None):
        '''
            Pytorch base class for an ImmersiveDepth dataset
...
class DefaultMultiviewSampler(MultiviewSampler):
    '''
        This sampler simply uses the structure of ImmersiveDepth files to infer multiview info. 
...
class CenterVisibleMultiviewSampler(MultiviewSampler):
    '''
        This sampler builds a graph of each ImmersiveDepth scene:
