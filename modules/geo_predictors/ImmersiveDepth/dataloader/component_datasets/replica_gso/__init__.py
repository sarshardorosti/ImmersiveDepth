...
from ...ImmersiveDepth_dataset import ImmersiveDepthDataset, load_subfolder
...
class GSOReplicaDataset(ImmersiveDepthDataset):

    def __init__(self, options: OImmersiveDepthDataset.Options, logger: logging.Logger=None):
