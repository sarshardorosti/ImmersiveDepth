...
from .task_configs import ImmersiveDepthSegm

# class ImmersiveDepthSegm:
#     @classmethod
#     def encode(cls, img):
#         ''' 
#           Takes a tensor [[B], C, W, H].
#           ImmersiveDepth encodes class + instance info into a png:
#             R: Class ID
...
def extract_instances(img, return_masks=False):    
    ...
    instance_map = ImmersiveDepthSegm.get_class_instance(img)
    class_map    = ImmersiveDepthSegm.get_class(img)
...
def plot_instances(
    ...
    for box, label, color in zip(boxes, labels, colors):
        ...
        clz, name = ImmersiveDepthSegm.get_class(label), ImmersiveDepthSegm.get_class_instance(label)
